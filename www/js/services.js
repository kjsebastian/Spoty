...
angular.module('spoty.services', []).
  value('version', '0.1');

// phonegap ready service - listens to deviceready
spoty.factory('phonegapReady', function() {
    return function (fn) {
        var queue = [];
        var impl = function () {
...
spoty.factory('geolocation', function ($rootScope, phonegapReady) {
  return {
...
spoty.factory('accelerometer', function ($rootScope, phonegapReady) {
    return {
...
spoty.factory('notification', function ($rootScope, phonegapReady) {
    return {
...
spoty.factory('navSvc', function($navigate) {
    return {
...
spoty.factory('compass', function ($rootScope, phonegapReady) {
    return {
...
spoty.factory('contacts', function ($rootScope, phonegapReady) {
    return {
